...
template<class T1, class T2>
class Material : public Oven<T1, T2> {
public:
	void input();
	void print();
	Material();
...
int main() {
	...
	cout << "Введите информацию о материале вашей печи:" << endl;
	Material1.input();
	...
	Material<int, char> Material3(Material1);
	Material3.print();
	cout << endl;
	...
	cout << endl << "Оператор ==" << endl;
	if (Material1 == Material2) cout << "Объекты равны" << endl;
	else cout << "Объекты не равны" << endl;

	// Оператор +
	cout << endl << "Оператор +" << endl;
	Oven1 = Material1 + Material2;
	Oven1.print();
